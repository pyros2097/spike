...
// values The array
// return this vector for chaining
func (self *Vector3) Set(values []float32) *Vector3 {
...
// vector The vector
// z The z-component
func (self *Vector3) Set(vector *Vector2, z float32) *Vector3 {
...
func (self *Vector3) Add(float x, float y, float z) *Vector3 {
...
func (self *Vector3) Crs(vector *Vector3) *Vector3 {
...
func (self *Vector3) MulM3(Matrix3 matrix) *Vector3 {
	l_mat := matrix.val
...
func (self *Vector3) TraMulM3(matrix *Matrix) *Vector3 {
	l_mat := matrix.val
...
func (self *Vector3) Rotate(degrees, axisX, axisY, axisZ float32) *Vector3 {
	return self.Mul(tmpMat.SetToRotation(axisX, axisY, axisZ, degrees))
}
...
func (self *Vector3) RotateRad(radians, axisX, axisY, axisZ float32) *Vector3 {
	return self.Mul(tmpMat.SetToRotationRad(axisX, axisY, axisZ, radians))
}

// Rotates this vector by the given angle in degrees around the given axis.
// axis the axis
// degrees the angle in degrees
func (self *Vector3) Rotate(axis *Vector3, degrees float32) *Vector3 {
	tmpMat.setToRotation(axis, degrees)
	return self.mul(tmpMat)
}

// Rotates this vector by the given angle in radians around the given axis.
// axis the axis
// radians the angle in radians
func (self *Vector3) RotateRad(axis *Vector3, radians float32) *Vector3 {
...
func (self *Vector3) IsUnit(margin float32) bool {
...
func (self *Vector3) IsZero(margin float32) bool {
	return self.Len2() < margin
}

func (self *Vector3) IsOnLine(other *Vector3, epsilon float32) bool {
...
func (self *Vector3) IsCollinear(other *Vector3, epsilon float32) bool {
...
func (self *Vector3) IsCollinearOpposite(other *Vector3, epsilon float32) bool {
...
func (self *Vector3) IsPerpendicular(vector *Vector3, epsilon float32) bool {
